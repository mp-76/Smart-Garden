...
//                                                                                              //
//                                                                                              //
// SLAVE1 program , target board: custom  ATMEGA328P board (Arduino standalone @16Mhz           //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
int SLAVE_ADDRESS = 1;
int DEMO_WATER_VOLUME = 10; //volume of water for the demo/override expressed in cm3
int DEMO_SLAVE_DELAY = 25000; //25 seconds

//plant specific
float CROP_COEFF = 0.2; //crop coefficient
