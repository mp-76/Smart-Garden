...
//                                                                                              //
//                                                                                              //
// SLAVE2 program , target board: custom  ATMEGA328P board (Arduino standalone @16Mhz           //
//////////////////////////////////////////////////////////////////////////////////////////////////
...
int SLAVE_ADDRESS = 2;
int DEMO_WATER_VOLUME = 20; //volume of water for the demo/override expressed in cm3
int DEMO_SLAVE_DELAY = 30000; //30 seconds

//plant specific
float CROP_COEFF = 0.5; //crop coefficient
...
{ 
  if(!myData.override_s)  //normal behavior -> make calculations and , if needed, give water
  {
    ...
    {
      if(computeWeeklyWater() < myData.s_2_max_cm3_week) //customize in other slaves..
      {
        if(getSoilHumidity() < myData.s_2_humidity_th) //customize in other slaves..
        {
